...
const Sidebar = ({ sidebarState, toggleSidebar }) => {
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 w-[250px] h-screen sm:hidden z-40 transition-all ease-in-out duration-500 bg-white ${
      ...
      >
        ...
        <ul className="flex flex-col mt-10 h-full">
          ...
          <li className="mt-auto mb-[200px] mx-auto"><a href="#contact" onClick={toggleSidebar} className="sm-hidden w-fit px-10 py-4 bg-black text-white font-semibold rounded-full">Connect With Me</a>
          </li>
        </ul>
